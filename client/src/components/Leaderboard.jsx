...
        const res = await axios.get(`${VITE_API_BASE_URL}/api/leaderboard`, {
...
        // Fallback to an empty array to prevent crashes
        setLeaderboard([]);
      }
      setLoading(false);
    };
...
            <p>No leaderboard data available. Try logging in or completing a session.</p>
          ) : (
